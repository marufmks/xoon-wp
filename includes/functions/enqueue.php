...
if ( ! function_exists( 'egns_scripts' ) ) {
	...
	function egns_enqueue_scripts() {
		...
		//Fonts
		wp_enqueue_style( 'google-font-xoon-wc', 'https://fonts.googleapis.com/css2?family=Cormorant+Infant:wght@300;400;500;600;700&family=Josefin+Sans:wght@300;400;500;600;700&family=Jost:wght@300;400;500;600;700;800&family=Mulish:wght@300;400;500;600;700;800&display=swap', array(), $the_theme->get( 'Version' ), 'all' );
		...
		wp_enqueue_script( 'magnefic-popup', get_template_directory_uri() . '/assets/js/magnific-popup.min.js', array( 'jquery' ), $the_theme->get( 'Version' ), true );

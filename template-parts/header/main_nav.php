<div class="main-nav">
    <div class="mobile-logo-area d-xl-none d-flex justify-content-between align-items-center">
        <div class="mobile-logo-wrap ">
            <?php
                if ( !empty( $egns_theme_options['header_logo']['url'] ) ) {
                    Egns_Helpers::get_theme_logo($egns_theme_options['header_logo']['url']);
                } else {
    ...
    <?php
        Egns_Helpers::egns_get_theme_menu('primary-menu', 'main-nav-wrapper', '<i class="bi bi-chevron-down"></i>', 'ul', 3);
    ?>
    <!-- mobile-search-area -->
    <div class="d-xl-none d-block">
        <?php  if( class_exists('CSF') && !empty( $egns_theme_options['header_button_text'] ) ) { ?>
    ...
    <?php if( true == Egns_Helpers::is_enabled( $egns_theme_options['header_contact_enable'], Egns_Helpers::egns_page_option_value('page_header_contact_enable'))  ) : ?>
    ...
    <div class="phone-call d-flex justify-content-start align-items-center flex-row d-xl-none d-block mt-5">
        ...
        <div class="number">
            ...
            <?php if( !empty( $egns_theme_options['header_contact_phone'] ) ) : ?>
                <h5><a href="tel:<?php echo str_replace(" ","",wp_kses( $egns_theme_options['header_contact_phone'], wp_kses_allowed_html('post') )); ?>"><?php echo wp_kses( $egns_theme_options['header_contact_phone'], wp_kses_allowed_html('post') ) ?></a></h5>
            <?php endif ?>
        </div>
    </div>
    <?php endif ?>
...
<header class="header-area style-2">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="header-logo">
            <a href="index.html"><img alt="image" class="img-fluid" src="assets/images/icons/header2-logo.svg"></a>
        </div>
        <div class="main-nav">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap ">
                    <a href="index.html"><img alt="image" src="assets/images/icons/header2-logo.svg"></a>
                </div>
                <div class="menu-close-btn">
            ...
            <ul class="menu-list">
                <li class="menu-item-has-children">
                    <a href="index.html" class="drop-down active">Home</a><i class='bi bi-chevron-down dropdown-icon'></i>
                    <ul class="sub-menu">
                        <li><a href="index.html">Travel Agency 01</a></li>
                        <li><a href="index-travel2.html">Travel Agency 02</a></li>
                        <li><a href="index-city-tour.html">City Tour</a></li>
                        <li><a href="index-adventure.html">Adventure</a></li>
                        <li><a href="index-wildlife.html">Wild life</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children">
                    <a href="destination.html" class="drop-down">Destination</a><i class='bi bi-chevron-down dropdown-icon'></i>
                    <ul class="sub-menu">
                ...
                <li class="menu-item-has-children">
                    <a href="blog-grid.html">Tours</a><i class='bi bi-chevron-down dropdown-icon'></i>
                    <ul class="sub-menu">
                        <li><a href="tour-package.html">Tour Package 1</a></li>
                        <li><a href="tour-package2.html">Tour Package 2</a></li>
                        <li><a href="tour-package-sidebar.html">Package Sidebar</a></li>
                        <li><a href="tour-package-details.html">Package Details</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="error.html">Submenu</a><i class='d-lg-flex d-none bi bi-chevron-right dropdown-icon'></i><i class='d-lg-none d-flex bi bi-chevron-down dropdown-icon'></i>
                            <ul class="sub-menu">
                                <li><a href="about.html">Children 1</a></li>
                                <li><a href="team.html">Children 2</a></li>
                                <li><a href="faq.html">Children 3</a></li>
                                <li><a href="error.html">Children 4</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="menu-item-has-children">
                    <a href="blog-grid.html">Blog</a><i class='bi bi-chevron-down dropdown-icon'></i>
                    <ul class="sub-menu">
            ...
            <a href="tour-package-details.html" class="eg-btn btn--primary btn--lg d-lg-none d-flex mt-5">Book A Trip</a>
        </div>

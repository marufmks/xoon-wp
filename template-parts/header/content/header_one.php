...
<header class="header-area style-1 bg-color2">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <!-- <a href="index.html"><img alt="image" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/header1-logo.svg"></a> -->
                    <?php
            ...
            <!-- <ul class="menu-list">
                <li class="menu-item-has-children">
                    <a href="index.html" class="drop-down">Home</a><i class="bi bi-circle-fill"></i>
                    <ul class="sub-menu">
                ...
                <li class="menu-item-has-children">
                    <a href="collection1.html">Collection</a><i class="bi bi-circle-fill"></i>
                    <ul class="sub-menu">
                ...
                <li class="menu-item-has-children">
                    <a href="#" class="drop-down">Pages</a><i class="bi bi-circle-fill"></i>
                    <ul class="sub-menu">
                ...
                <li class="menu-item-has-children">
                    <a href="blog-grid.html" class="active">Blog</a><i class="bi bi-circle-fill"></i>
                    <ul class="sub-menu">
                        <li><a href="blog-grid.html">Blog Grid</a></li>
                        <li><a href="blog-standard.html" class="active">Blog Standard</a></li>
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            ...
            <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_one_menu_button')) && (Egns_Helpers::egns_get_theme_option('header_one_menu_button')   ==  1) && class_exists('CSF')) :  ?>
                <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_one_button_url'))) :   ?>
                    <a href="<?php echo esc_url(Egns_Helpers::egns_get_theme_option('header_one_button_url')) ?>" class="eg-btn btn--primary-outline btn--lg d-xl-flex d-none">
                        <?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_one_button_text')) ?>
                    </a>
                <?php endif ?>
            <?php endif ?>
            ...
            <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_one_menu_sidebar')) && (Egns_Helpers::egns_get_theme_option('header_one_menu_sidebar')   ==  1) && class_exists('CSF')) :  ?>
...
<div class="main-nav-wrapper">
    <div class="main-nav">
        ...
        <?php
        Egns_Helpers::egns_get_theme_menu('primary-menu', 'sidebar-menu-area', '<i class="bi bi-plus-lg dropdown-icon"></i>', 'ul', 3);
        ?>

        <div class="sidebar-menu-contact d-flex justify-content-start">
            <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_one_sidebar_url_one'))) :   ?>
                <a href="<?php echo esc_url(Egns_Helpers::egns_get_theme_option('header_one_sidebar_url_one')) ?>" data-cursor="<?php echo esc_attr__(Egns_Helpers::egns_get_theme_option('header_one_sidebar_text_one'), 'egns-core') ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/opensea-icon.svg" class="img-fluid" alt="<?php echo esc_attr('sidebar-image') ?>"></a>
            <?php endif ?>

            <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_one_sidebar_url_two'))) : ?>
                <a href="<?php echo esc_url(Egns_Helpers::egns_get_theme_option('header_one_sidebar_url_two')) ?>" data-cursor="<?php echo esc_attr__(Egns_Helpers::egns_get_theme_option('header_one_sidebar_text_two'), 'egns-core') ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/discord-icon.svg" class="img-fluid" alt="<?php echo esc_attr('sidebar-image') ?>"></a>
                </a>
            <?php endif; ?>
        </div>
        <div class=" sidebar-social d-flex justify-content-center gap-5">
            <?php if (is_array(Egns_Helpers::egns_get_theme_option('header_one_social_link'))) : ?>
                <?php foreach (Egns_Helpers::egns_get_theme_option('header_one_social_link') as $roww) : ?>
                    <a href="<?php echo esc_url($roww['header_one_social_link_url']) ?>"><img src="<?php echo esc_url($roww['header_one_sidebar_social_image']['url']) ?>" alt="image"></a>
                <?php endforeach ?>
            <?php endif ?>
        </div>
    </div>
